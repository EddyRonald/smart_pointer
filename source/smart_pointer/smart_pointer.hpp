...
class SmartPointer {
 ...
 public:
   ...
   */
  explicit SmartPointer(Type *resource): resource_(resource), counter_(new size_t(1)){}
  SmartPointer(): resource_(nullptr),counter_(nullptr){}
   ...
   */
  size_t GetReferenceCount() const { return *counter_; }
